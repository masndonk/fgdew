$(document).ready(function() {
	var linkpub = 'http://ow.ly/qY3K30gRtlT';
	var count = 0;
	// Tiempo respuesta
	var tmres = 2500;
	// Duración vieo
	...
	// Primer mensaje
	var msjs1 = [
		'Hei, jeg er ensom i dag, jeg trenger noen til å følge med meg i sengen min <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(6).jpg"/>',
	];
	var msj1 = msjs1[Math.floor(Math.random()*msjs1.length)];
	// Segundo mensaje
	var msjs2 = [
		'bare lage en ny profil der, og jeg ringer deg kjære <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(3).jpg"/>',
	];
	var msj2 = msjs2[Math.floor(Math.random()*msjs2.length)];
	// Tercer mensaje
	var msjs3 = [
		'har du sett videoen min? <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(1).jpg" style="margin-left:0"/> <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(1).jpg"/>',
	];
	var msj3 = msjs3[Math.floor(Math.random()*msjs3.length)];
	// Mensaje final
	var msjsf = [
		'Hvis du allerede er inne, send meg navnet ditt på nettstedet mitt, jeg ringer deg der <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(2).jpg"/>',
	];
